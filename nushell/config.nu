...
alias cg = zed ~/dotfiles/gdb/.gdbinit

alias cpg = cp `~/dotfiles/.gitignore` `.gitignore`
alias cpp = cp `~/dotfiles/pyright/pyrightconfig.json` `pyrightconfig.json`
...
alias gdb = /usr/local/bin/gdb -x ~/dotfiles/gdb/.gdbinit
